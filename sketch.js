...
function setup() {
  ...
  bubble = createSprite(600,460,20,20);
  ...
  blink.frameDelay = 20;
  eat.frameDelay = 20;
  bunny = createSprite(490,100,100,100);
  bunny.addImage(rabbit);
  bunny.scale = 0.2;
  higherground =new Ground(520,170,100,10);
  ...
  rope = new Rope(4,{x:490,y:280});
  rope2 = new Rope(4,{x:580,y:450});
  con = new Link(rope,fruit);
  con2 = new Link(rope2,fruit);

  //btn 1
  button = createImg('cut_btn.png');
  button.position(490,280);
  button.size(50,50);

  button2 = createImg('cut_btn.png');
  button2.position(580,420);
  button2.size(50,50);
